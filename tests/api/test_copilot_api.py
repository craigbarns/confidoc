...
class _FakeDb:
    def __init__(
        self, document: Document, version: DocumentVersion, mapping: PseudonymMapping
    ) -> None:
...
@pytest.mark.asyncio
async def test_copilot_ask_allowed_if_medium_risk_and_autopilot_validated(
    client, _copilot_setup
) -> None:
...
@pytest.mark.asyncio
async def test_copilot_ask_allowed_if_medium_risk_and_human_validated(
    client, _copilot_setup
) -> None:
    _, _, doc, _, mapping = _copilot_setup
...
@pytest.mark.asyncio
async def test_copilot_ask_blocked_if_high_risk_and_autopilot_validated(
    client, _copilot_setup
) -> None:
    _, _, doc, _, mapping = _copilot_setup
