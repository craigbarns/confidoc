...
class GDPRProcessingRegister(Base):
    ...
    legal_basis = Column(String(255), nullable=False)  # Base légale (ex: Consentement, Contrat, Obligation légale)
    ...
    security_measures = Column(Text, nullable=False)  # Mesures de sécurité (techniques et organisationnelles)
