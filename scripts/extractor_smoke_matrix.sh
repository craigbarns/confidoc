...
#
# Optionnel (e2e_smoke) — faire échouer si coverage trop basse :
#   CONFIDOC_SMOKE_MIN_COVERAGE_BILAN
#   CONFIDOC_SMOKE_MIN_COVERAGE_CR
#   CONFIDOC_SMOKE_MIN_COVERAGE_2072
